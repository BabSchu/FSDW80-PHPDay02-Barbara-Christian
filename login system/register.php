...
if (isset($_POST['btn-signup'])) {
    ...
    if (!$error) {
        $query = "INSERT INTO users(userName,userEmail,userPass) VALUES('$name','$email','$passw" +
                "ord')";
...
?>
      ...
      <div class="col-sm-4 offset-4 p-5">
         <form method="post"  action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"  autocomplete="off" >
            ...
            <span class="text-dark mr-3">You have already an account?</span><a href="login.php"><button type="button" class="btn btn-outline-info">Sign in Here</button></a>
